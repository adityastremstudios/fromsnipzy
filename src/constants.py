...
tips = (
    ...
    "You can set custom reactions for tourneys & scrims with Punisher Scrims.",
    "You can add a role to multiple users with `role @role @user @user2...` command.",
    "Punisher Scrims can detect and verify youtube/insta/loco,etc. screenshots (`ssverify` cmd).",
    ...
    "With Punisher Scrims you can set custom DM message.",
)
...
async def remind_premium(ctx):
    ...
    _e.description = (
    "Your guild's premium subscription is ending soon..."
      )
